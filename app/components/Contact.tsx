    ...
    <div className="max-w-4xl mx-auto">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-8 py-16 px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="text-center lg:text-left space-y-8 w-full lg:w-1/2 lg:pr-4"
        >
          <div>
        ...
        <motion.div
          ...
          className="relative w-[250px] h-[333px] sm:w-[300px] sm:h-[400px] mx-auto mt-8 lg:mt-0 lg:w-1/2 lg:pl-4 flex justify-center"
        >
